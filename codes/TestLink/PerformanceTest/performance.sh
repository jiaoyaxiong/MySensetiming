...
wenjianjianame=$1
mkdir -p raw_data/${wenjianjianame}
file_name=raw_data/${wenjianjianame}
...
while true;do iostat -c  |sed -n 4p | awk '{print $NF}'>>${file_name}/cpu_idle.txt; sleep ${cpu_interval} ;done &
pid_cpu=`echo $!`
