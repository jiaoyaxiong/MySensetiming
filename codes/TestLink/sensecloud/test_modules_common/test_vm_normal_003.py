...
class test_vm_normal_003(common.sensemediaTestBase):
    ...
    def __init__(self):
        ...
        self.file = ""
        # TODO
        self.video_url = "https://172.20.14.63:6554/baoli.mp4"
        # self.video_url = "https://172.20.14.63:6554/hebing/baoli_14g.mp4"
    ...
    def check_result_urls(self,res_res_url,resp_id):
        ...
        if "ISIS" not in str(r_json):
            self.logger.error("not find string ISIS ")
            assert False
