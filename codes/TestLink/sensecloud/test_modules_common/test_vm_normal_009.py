...
class test_vm_normal_009(common.sensemediaTestBase):
    ...
    def __init__(self):
        ...
        self.video_url = "https://172.20.14.63:6554/xidada.mp4"
        ...
        #期望使用的modules
        self.expect_modules=["shot_split",]
        #probability 最低限度
    ...
    def check_result_urls(self,res_res_url,resp_id):
        ...
        #
        #
        # if repr(u"习近平") not in str(r_json):
        #     self.logger.error("not find string yellow ")
        #     assert False
