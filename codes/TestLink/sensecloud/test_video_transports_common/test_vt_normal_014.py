...
class test_vt_normal_014(common.sensemediaTestBase):

    def __init__(self):
        super(test_vt_normal_014, self).__init__("test_vt_normal_014")
        ...
        # request url
        self.file =("123.ts", open('/codes/sensecloud/test_video_transports_common/123.ts', 'rb'), "application/octet-stream")
        # TODO
