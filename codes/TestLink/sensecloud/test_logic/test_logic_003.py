...
23，　修改李大锤　为　李锤大
24，搜索　李锤大
25，　使用Ｆilter 分析李锤大的　视频，　必须分析出来
26，删除　李锤大
27，搜索　李锤大
28，使用Ｆilter 分析李锤大的　视频，　分析不出来李锤大　　　
29，　删除　子库　朋友圈高官
30，　删除　标签　绝色高官
31，　确认图片已删除
32，　确认子库已删除
...
class test_logic_003(common.sensemediaTestBase):

    def __init__(self):
        super(test_logic_003, self).__init__("test_logic_003")
    ...
    def setup(self):
        ...
        # 删人
        self.logger.info("---setup，删除　李锤大 李大锤")
        data_26 = {"name": "李锤大,李大锤,李锤大1"}
        ...
        # 删库
        self.logger.info("---setup  删除　朋友圈大高官　朋友圈高官 子库")
        data_5 = {"name": "朋友圈大高官,朋友圈高官"}
        ...
        # 删标签
        self.logger.info("---setup  删除标签　绝色大高官 绝色高官")
        data_12 = {"name": "绝色大高官,绝色高官"}
    ...
    def test_001(self):
        ...
        # 1,新增一个子库：　朋友圈高官
        self.logger.info("---step1  make a new lib 朋友圈高官")
        url_1 = self.baseurl + "/sensemedia/face_in/v2/parts"
        data_1 = {"name": "朋友圈高官", "db_name": "涉政"}
        ...
        # 2 搜索子库　是否存在
        self.logger.info("---step2  搜索子库　是否存在 朋友圈高官")
        ...
        if "朋友圈高官" not in r_2.text.encode("utf-8"):
            self.logger.error("not find　子库　朋友圈高官")
            assert False

        # ３，修改子库名：　朋友圈高官　朋友圈大高官

        self.logger.info("---step3  修改子库名：　朋友圈高官　朋友圈大高官")
        data_3 = {"parts": [{"origin_part": "朋友圈高官", "part": "朋友圈大高官"}]}
        ...
        # 4,搜索子库　是否存在　　　　
        self.logger.info("---step4  搜索子库　是否存在 朋友圈大高官")
        ...
        if "朋友圈大高官" not in r_4.text.encode("utf-8"):
            self.logger.error("not find　子库　朋友圈大高官")
            assert False

        if "朋友圈高官" in r_4.text.encode("utf-8"):
            self.logger.error("find　子库　朋友圈高官，not as expected")
            assert False

        # 5,删除　朋友圈大高官　子库

        self.logger.info("---step5  删除　朋友圈大高官　子库")
        data_5 = {"name": "朋友圈大高官"}
        ...
        self.logger.info("---step6  搜索子库　是否存在 朋友圈大高官 朋友圈高官　")
        ...
        if "朋友圈大高官" in r_6.text.encode("utf-8"):
            self.logger.error("find　子库　朋友圈大高官, not as expected !")
            assert False

        if "朋友圈高官" in r_6.text.encode("utf-8"):
            self.logger.error("find　子库　朋友圈高官，not as expected ! ")
            assert False

        # 7,新增一个子库：　朋友圈高官

        self.logger.info("---step7  make a new lib 朋友圈高官")
        url_7 = self.baseurl + "/sensemedia/face_in/v2/parts"
        data_7 = {"name": "朋友圈高官", "db_name": "涉政"}
        ...
        self.logger.info("---step8  add a label 绝色高官　")
        ...
        self.logger.info("---step9  搜索标签　绝色高官　")
        ...
        if "绝色高官" not in r_9.text.encode("utf-8"):
            self.logger.error("not find　标签　绝色高官, not as expected !")
            assert False

        # 10,修改标签　　绝色高官　绝色大高官　

        self.logger.info("---step10  修改标签：　绝色高官　绝色大高官")
        data_10 = {"labels": [{"origin_label": "绝色高官", "label": "绝色大高官"}]}
        ...
        self.logger.info("---step11  查询标签　　绝色大高官　")
        ...
        if "绝色高官" in r_11.text.encode("utf-8"):
            self.logger.error(" find　标签　绝色高官, not as expected !")
            assert False

        if "绝色大高官" not in r_11.text.encode("utf-8"):
            self.logger.error(" not find　标签　绝色大高官, not as expected !")
            assert False

        # 12，删除标签　绝色大高官

        self.logger.info("---step12  删除标签　绝色大高官")
        data_12 = {"name": "绝色大高官"}
        ...
        self.logger.info("---step13  查询标签　　绝色大高官　")
        ...
        if "绝色高官" in r_13.text.encode("utf-8"):
            self.logger.error(" find　标签　绝色高官, not as expected !")
            assert False

        if "绝色大高官" in r_13.text.encode("utf-8"):
            self.logger.error(" find　标签　绝色大高官, not as expected !")
            assert False

        # １4，新增标签　绝色高官

        self.logger.info("---step14  add a label 绝色高官　")
        ...
        self.logger.info("---step15  查询标签　　绝色高官　")
        ...
        if "绝色高官" not in r_15.text.encode("utf-8"):
            self.logger.error(" not find　标签　绝色高官, not as expected !")
            assert False

        if "绝色大高官" in r_15.text.encode("utf-8"):
            self.logger.error("  find　标签　绝色大高官, not as expected !")
            assert False

        # 16，朋友圈高官图片两张　入库　　　李大锤　　

        self.logger.info("---step16  朋友圈高官图片两张　入库　　　李大锤  涉政　")

        url_16 = self.baseurl + "/sensemedia/face_in/v2/persons/?db_name=涉政"
        self.file = ("lidacui.zip", open('/codes/sensecloud/test_logic/lidacui.zip', 'rb'), "application/zip")
        # 请求体
        ...
        r_16 = requests.post(url_16, data=self.body, headers=self.headers)
        ...
        # # 18，删除高官图片一张　lixingmeng1.png

        self.logger.info("---step18  删除高官图片一张　lixingmeng1.png")
        data_18 = {"id": id}
        ...
        self.logger.info("---step20  人物搜索接口，可以搜索到李大锤 ")
        ...
        if "李大锤" not in r_20.text.encode("utf-8"):
            self.logger.error("not find 李大锤, not as expected ！")
            assert False

        # 21，主库添加人物李大锤到　子库　 朋友圈高官

        self.logger.info("---step21  主库添加人物李大锤到　子库　 朋友圈高官　")
        url_21 = self.baseurl + "/sensemedia/face_in/v2/persons/copy"
        data_21 = {"part": "朋友圈高官", "persons": ["李大锤"]}
        ...
        self.logger.info("---step22  人物搜索接口，可以搜索到李大锤 ")

        url_22 = self.baseurl + "/sensemedia/face_in/v2/persons"

        payload = {'name': '李大锤', "db_name": "朋友圈高官"}
        ...
        if "李大锤" not in r_22.text.encode("utf-8"):
            self.logger.error("not find 李大锤, not as expected ！")
            assert False

        # 23，　修改李大锤　为　李锤大

        self.logger.info("---step23  修改李大锤　为　李锤大")
        data_23 = {"persons": [{"origin_name": "李大锤", "name": "李锤大"}]}
        ...
        self.logger.info("---step24  人物搜索接口，可以搜索到李锤大 ")

        url_24 = self.baseurl + "/sensemedia/face_in/v2/persons"

        payload = {'name': '李锤大', "db_name": "朋友圈高官"}
        ...
        if "李锤大" not in r_24.text.encode("utf-8"):
            self.logger.error("not find 李锤大, not as expected ！")
            assert False

        # 25，　使用Ｆilter分析李锤大的　视频，　必须分析出来

        self.logger.info("---step25，　使用Ｆilter分析李锤大的视频，两分钟内必须分析出来 ")
        ...
        # 判断李锤大是否在不在结果中
        if repr(u"李锤大") not in str(r_json):
            self.logger.error("not find 李锤大，not as expected !")
            assert False

        # 26，删除　李锤大
        self.logger.info("---step26，删除　李锤大")
        data_26 = {"name": "李锤大"}
        url_26 = self.baseurl + "/sensemedia/face_in/v2/persons"
        r_26 = requests.delete(url_26, params=data_26)
        ...
        self.logger.info("---step27  人物搜索接口，搜索不到李锤大 ")

        url_27 = self.baseurl + "/sensemedia/face_in/v2/persons "

        payload = {'name': '李锤大', "db_name": "朋友圈高官"}
        r_27 = requests.get(url_27, params=payload, headers=self.json_headers)
        ...
        if "李锤大" in r_27.text.encode("utf-8"):
            self.logger.error("find 李锤大, not as expected ！")
            assert False

        # 28，使用Ｆilter分析李锤大的　视频，　分析不出来李锤大　　　

        self.logger.info("---step28，使用Ｆilter分析李锤大的　视频，　分析不出来李锤大　 ")
        self.video_url = "https://172.20.14.63:6554/lixingmeng.mp4"
        self.callback = "http://172.20.23.42:22222/callback"
        self.token = "bbbbbbbbbbbbbbbbbbbbbbbbbbbb"
        self.db_name = "朋友圈高官"
        ...
        self.logger.info("---step27  删除　朋友圈高官　子库")
        data_27 = {"name": "朋友圈高官"}
        ...
        self.logger.info("---step30  删除标签　绝色高官")
        data_30 = {"name": "绝色高官"}
        ...
        self.logger.info("---step32  搜索子库　是否存在 朋友圈大高官 朋友圈高官　")
        ...
        if "朋友圈大高官" in r_32.text.encode("utf-8"):
            self.logger.error("find　子库　朋友圈大高官")
            assert False

        if "朋友圈高官" in r_32.text.encode("utf-8"):
            self.logger.error("find　子库　朋友圈高官，not as expected")
            assert False

        # 33，　确认标签已删除

        self.logger.info("---step33  搜索标签　绝色高官　")
        ...
        if "绝色高官" in r_33.text.encode("utf-8") or "绝色大高官" in r_33.text.encode("utf-8"):
            self.logger.error("find　标签　绝色高官, not as expected !")
            assert False
        ...
        if "李大锤" in r_34.text.encode("utf-8") or "李锤大" in r_34.text.encode("utf-8"):
            self.logger.error(" find 李大锤 or　李锤大　, not as expected ！")
            assert False

        # TODO(不能分析出其他人，否则认为失败)
