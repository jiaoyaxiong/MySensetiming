...
class test_logic_001(common.sensemediaTestBase):

    def __init__(self):
        super(test_logic_001, self).__init__("test_logic_001")
    ...
    def test_001(self):
        ...
        self.file =("lixingmeng.zip", open('/codes/sensecloud/test_logic/lixingmeng.zip', 'rb'), "application/zip")
        # 请求体
