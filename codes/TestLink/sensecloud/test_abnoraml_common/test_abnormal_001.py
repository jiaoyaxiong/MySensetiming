...
@attr(feature="test_abnormal_common")
...
class test_abnormal_001(common.sensemediaTestBase):
    ...
    def test_001(self):
        ...
        if r.json().get("message") != "Request submitted successfully":
            self.logger.error("should get Request submitted successfully ,not as expected" )
            assert False
