...
class test_vm_abnormal_002(common.sensemediaTestBase):
    ...
    def __init__(self):
        ...
        # TODO
        self.video_url = "https://172.20.14.63:6554/renmingdemingyi.mp4"
    ...
    def test_001(self):
        ...
        if r.json().get("error_msg") != "Module interval is not legal: module is filter_terror":
            self.logger.error("Module interval is not legal: module is filter_terror ,but is %s " % r.json().get("error_msg"))
            assert False
