...
class test_vd_normal_002(common.sensemediaTestBase):
    ...
    def __init__(self):
        ...
        self.body = {
            ...
            "modules":"filter_politician,filter_star"
        }
        # 请求头
        ...
        #期望使用的modules
        self.expect_modules=["filter_politician","filter_star"]
        #probability 最低限度
    ...
    def check_result_urls(self,res_res_url,resp_id):
        ...
        if repr(u"陆毅") not in str(r_json):
            self.logger.error("not find 陆毅 ，not as expected")
            assert False
